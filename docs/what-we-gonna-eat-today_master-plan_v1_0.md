...
| `E4-T6` | Retry khi mất mạng, không chặn thao tác | `NFR-05`, `S-09` | 1.5 | `E4-T5` | Tắt mạng vẫn vuốt tiếp được, có dải thông báo ở đỉnh | `src/features/selection/presentation/**` |
